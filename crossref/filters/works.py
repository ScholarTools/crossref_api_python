...
# -*- coding: utf-8 -*-
"""
from crossref.filters import works as wf
"""
...
#The idea is to do something like _filter={wf.type:'journal',etc.}

has_funder = 'has-funder' #Requires t, true, 1, f, false 0
funder = 'funder'   #metadata which include the {funder_id} in FundRef data
location = 'location'
prefix = 'prefix'
member = 'member'
...
from_created_date	= 'from-created-date'   #{date}	metadata first deposited since (inclusive) {date}
